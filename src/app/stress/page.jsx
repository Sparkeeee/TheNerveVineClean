          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3stress-adaptogens" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3stress-magnesium" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3stress-theanine" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3stress-bcomplex" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
              </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                ...
                <Link href="/symptoms/burnout" className="block text-blue-600 hover:text-blue-800 transition-colors">
                  → Burnout
                </Link>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <Link href="/herbs/ashwagandha" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Ashwagandha (Adaptogen)
                </Link>
                <Link href="/herbs/reishi" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Reishi (Immune Support)
                </Link>
                <Link href="/herbs/holy-basil" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Holy Basil (Mental Clarity)
                </Link>
                <Link href="/herbs/siberian-ginseng" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Siberian Ginseng (Stress Resistance)
                </Link>
                <Link href="/herbs/lemon-balm" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Lemon Balm (Calming)
                </Link>
                <Link href="/herbs/skullcap" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Skullcap (Nervine)
                </Link>
                <Link href="/herbs/kava-kava" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Kava Kava (Anxiety Relief)
                </Link>
                <Link href="/herbs/passionflower" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Passionflower (GABA Enhancement)
                </Link>
                <Link href="/herbs/california-poppy" className="block text-green-600 hover:text-green-800 transition-colors">
                  → California Poppy (Gentle Sedative)
                </Link>
                <Link href="/herbs/blue-vervain" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Blue Vervain (Nervous Tonic)
                </Link>
                <Link href="/herbs/wood-betony" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Wood Betony (Headache Relief)
                </Link>
                <Link href="/herbs/hops" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Hops (Sleep Support)
                </Link>
                <Link href="/herbs/magnolia-bark" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Magnolia Bark (Ancient Calm)
                </Link>
                <Link href="/herbs/schisandra" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Schisandra (Stress Resilience)
                </Link>
                <Link href="/herbs/gotu-kola" className="block text-green-600 hover:text-green-800 transition-colors">
                  → Gotu Kola (Brain Tonic)
                </Link>
                <Link href="/herbs/bacopa" className="block text-green-600 hover:text-green-800 transition-colors">

            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                <div className="border border-blue-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3example5" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon
                  </a>
                </div>
                ...
                <div className="border border-blue-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3example6" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon
                  </a>
                </div>
                ...
                <div className="border border-blue-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3example7" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon
                  </a>
                </div>
                ...
                <div className="border border-blue-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3example8" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon
                  </a>
                </div>
                ...
                <div className="border border-blue-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3example9" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon
                  </a>
                </div>
              </div>

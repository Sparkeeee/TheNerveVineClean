          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3dysbiosis-probiotics" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3dysbiosis-prebiotics" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3dysbiosis-glutamine" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3dysbiosis-omega3" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
              </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <Link href="/symptoms/digestive-health" className="block text-blue-600 hover:text-blue-800 transition-colors">
                  → Digestive Health
                </Link>

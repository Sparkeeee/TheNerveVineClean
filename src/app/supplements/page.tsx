  ...
  return (
    <div className="min-h-screen bg-white relative" style={{
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-8">
                 <div className="rounded-xl p-8 shadow-sm border-2 border-gray-300 mb-8 border-b-2 border-b-gray-300" style={{background: 'linear-gradient(135deg, #fffef7 0%, #fefcf3 50%, #faf8f3 100%)'}}>

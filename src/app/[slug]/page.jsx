...
export default function SymptomPage(_a) {
    return __awaiter(this, arguments, void 0, function* ({ params }) {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {symptom.paragraphs && Array.isArray(symptom.paragraphs) && (<div className="mb-8 space-y-4">
            {symptom.paragraphs.map((para, idx) => (<p key={idx} className="text-gray-700 text-base">{para}</p>))}
          </div>)}

        {/* Variant Recommendations */}
        {symptom.variants ? (<div className="space-y-10">
            {Object.entries(symptom.variants).map(([variant, data]) => {
                    var _a, _b, _c, _d, _e, _f, _g, _h, _j;
                    return (<div key={variant} className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-blue-900 font-medium">{(_a = data.bestHerb) === null || _a === void 0 ? void 0 : _a.name}</span>
                    <span className="text-green-600 font-medium">{(_b = data.bestHerb) === null || _b === void 0 ? void 0 : _b.price}</span>
                  </div>
                  <p className="text-gray-600 text-sm mb-2">{(_c = data.bestHerb) === null || _c === void 0 ? void 0 : _c.description}</p>
                  <a href={(_d = data.bestHerb) === null || _d === void 0 ? void 0 : _d.affiliateLink} target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">View Product &rarr;</a>
                </div>
                <div className="mb-4">
                  <h3 className="font-semibold text-blue-700">Best Standardized Extract</h3>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-blue-900 font-medium">{(_e = data.bestStandardized) === null || _e === void 0 ? void 0 : _e.name}</span>
                    <span className="text-green-600 font-medium">{(_f = data.bestStandardized) === null || _f === void 0 ? void 0 : _f.price}</span>
                  </div>
                  <p className="text-gray-600 text-sm mb-2">{(_g = data.bestStandardized) === null || _g === void 0 ? void 0 : _g.description}</p>
                  <a href={(_h = data.bestStandardized) === null || _h === void 0 ? void 0 : _h.affiliateLink} target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">View Product &rarr;</a>
                </div>
                <div>
                  <h3 className="font-semibold text-blue-700 mb-2">Top Non-Herbal Supplements</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    {(_j = data.topSupplements) === null || _j === void 0 ? void 0 : _j.map((supp, idx) => (<div key={idx} className="border border-blue-200 rounded-lg p-4 hover:shadow-md transition-shadow">
            ...
            {symptom.bestHerb && (<div className="bg-white rounded-lg p-6 shadow-lg mb-6">
            ...
            {symptom.bestStandardized && (<div className="bg-white rounded-lg p-6 shadow-lg mb-6">
            ...
            {symptom.topSupplements && (<div className="bg-white rounded-lg p-6 shadow-lg mb-6">
                <h2 className="text-2xl font-semibold text-blue-800 mb-4">Top Non-Herbal Supplements</h2>
                <div className="grid md:grid-cols-2 gap-4">
                  {symptom.topSupplements.map((supp, idx) => (<div key={idx} className="border border-blue-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                      <div className="flex items-start justify-between mb-2">
                        <span className="text-blue-900 font-medium">{supp.name}</span>
                        <span className="text-green-600 font-medium">{supp.price}</span>
                      </div>

...
export default function FatiguePage() {
    return (<div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <h1 className="text-4xl font-bold text-gray-800 mb-6">Fatigue & Energy Support</h1>
        
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-100">
          <p className="text-lg text-gray-700 mb-6">
            Persistent fatigue can be debilitating and often indicates underlying nervous system 
            or adrenal issues. Natural herbs and supplements can help restore energy levels 
            and support your body&apos;s natural vitality.
          </p>
          
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            <div className="bg-blue-50 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-blue-800 mb-4">Energy Herbs</h2>
              <ul className="space-y-3">
                ...
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span>
                  <Link href="/herbs/ginseng" className="text-blue-600 hover:text-blue-800">
                    Ginseng
                  </Link>
                </li>
                <li className="flex items-center">
            ...
            <div className="bg-green-50 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-green-800 mb-4">Energy Supplements</h2>
              <ul className="space-y-3">
                <li className="flex items-center">
                  <span className="text-green-600 mr-2">✓</span>
          ...
          <div className="mt-8 text-center">
            <Link href="/systems/nervous" className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-md hover:shadow-lg">

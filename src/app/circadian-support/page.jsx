          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3circadian-melatonin" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3circadian-glasses" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3circadian-magnesium" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3circadian-theanine" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <a href="https://amzn.to/3circadian-tracker" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors text-sm">
                    View on Amazon →
                  </a>
                </div>
              </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <div className="space-y-2">
                ...
                <Link href="/symptoms/insomnia" className="block text-blue-600 hover:text-blue-800 transition-colors">
                  → Insomnia
                </Link>
              </div>
            </div>

...
export function GET(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (id) {
                const symptom = yield prisma.symptom.findUnique({ where: { id: Number(id) } });
                if (!symptom)
...
export function POST(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const symptom = yield prisma.symptom.create({ data });
...
export function PUT(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const symptom = yield prisma.symptom.update({ where: { id: data.id }, data });
            return NextResponse.json(symptom);
        }
        catch (error) {
            return NextResponse.json({ error: error instanceof Error ? error.message : String(error) }, { status: 400 });

...
export default function HerbSubstancePage() {
    ...
    const fetchHerbInfo = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    const fetchPendingProducts = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const mockProducts = [
                {
                    id: '1',
                    name: `${(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name) || 'Herb'} Tincture`,
                    brand: 'Gaia Herbs',
                    price: 24.99,
                    rating: 4.5,
                    reviewCount: 127,
                    ...
                    description: `Organic ${(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name) || 'herb'} tincture, 1:2 ratio, organic alcohol`,
                    qualityScore: 85,
                ...
                {
                    id: '2',
                    name: `${(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name) || 'Herb'} Extract Capsules`,
                    brand: 'Nature\'s Way',
                    price: 18.99,
                    rating: 4.2,
                    reviewCount: 89,
                ...
                {
                    id: '3',
                    name: `${(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name) || 'Herb'} Root Powder`,
                    brand: 'NOW Foods',
                    price: 12.99,
                    rating: 4.7,
                    reviewCount: 234,
                    ...
                    description: `Organic ${(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name) || 'herb'} root powder, 8oz`,
                    qualityScore: 72,
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                {herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.name}
              </h1>
              {(herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.latinName) && (<p className="text-lg text-gray-600 italic">{herbInfo.latinName}</p>)}
              <p className="text-gray-600 mt-2">{herbInfo === null || herbInfo === void 0 ? void 0 : herbInfo.description}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {pendingProducts.length === 0 ? (<div className="text-center py-12">
              ...
              {pendingProducts.map((product) => (<div key={product.id} className={`border rounded-lg p-6 hover:shadow-lg transition ${selectedProducts.includes(product.id) ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}>
                  {/* Product Image */}
                  <div className="mb-4">
                    <Image src={product.image || '/images/placeholder-product.jpg'} alt={product.name} width={200} height={120} className="w-full h-48 object-cover rounded-md" onError={(e) => {

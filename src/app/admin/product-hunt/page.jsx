...
export default function ProductHuntDashboard() {
    ...
    const fetchSubstances = () => __awaiter(this, void 0, void 0, function* () {
        setLoading(true);
        try {
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-lg shadow border border-gray-200 p-6 flex flex-wrap items-center gap-4">
            ...
            <button className="bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-6 rounded shadow" type="button" onClick={handleTriggerHuntNow}>
              Trigger Hunt Now
            </button>
          </div>
        </div>
        ...
        {loading ? (<div className="text-center py-12">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {herbs.map((herb) => (<Link key={herb.id} href={`/admin/product-hunt/herbs/${herb.slug}`} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex items-center space-x-2">
                      {herb.pendingCount > 0 && (<span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {supplements.map((supplement) => (<Link key={supplement.id} href={`/admin/product-hunt/supplements/${supplement.slug}`} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-center space-x-2">
                      {supplement.pendingCount > 0 && (<span className="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded-full">
        ...
        <div className="mt-8 flex gap-4">
          ...
          <Link href="/admin/data-hub" className="bg-purple-600 text-white px-6 py-3 rounded-md hover:bg-purple-700 transition font-medium">
            Data Processing Hub
          </Link>
        </div>
        {/* Clear All Pending Button */}
        <div className="flex justify-end mt-8">
          <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded shadow" type="button" onClick={() => {

        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-blue-100 w-full max-w-none flex flex-col items-center px-0 relative">
          ...
          <div className="w-full grid grid-cols-3 items-center gap-4 py-6 px-4 md:px-12 max-md:grid-cols-1 max-md:gap-6">
            <div className="flex justify-center">
              <Image src="/images/Logo with Vitality Theme.png" alt="The NerveVine Logo with Vitality Theme" width={210} height={210} className="max-w-[210px] w-full h-auto" style={{ objectFit: 'contain' }} priority/>
            </div>
            ...
            <div className="flex justify-center">
              <Image src="/images/Venn1.png" alt="NerveVine Venn Diagram" width={250} height={250} className="max-w-[250px] w-full h-auto" style={{ objectFit: 'contain' }} priority/>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-center px-0">
            ...
            <div className="text-center mt-8">
              <Link href="/systems/nervous" className="inline-flex items-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-md hover:shadow-lg">

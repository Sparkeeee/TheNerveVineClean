...
function getHerb(slug) {
    return __awaiter(this, void 0, void 0, function* () {
        const prisma = new PrismaClient();
        try {
            const herb = yield prisma.herb.findFirst({
                where: { slug: slug }
            });
            return herb;
        }
...
function getMockProducts(herbName) {
    return [
        {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
          <div className="flex-shrink-0">
            <Image src={herb.heroImageUrl || '/images/placeholder.png'} alt={herb.name || 'Herb image'} width={200} height={200} className="rounded-full object-cover shadow-lg border-4 border-white"/>
          </div>
          <div className="text-center md:text-left">
            <h1 className="text-4xl font-bold text-purple-900 mb-2">{herb.name}</h1>
            {herb.latinName && (<p className="text-xl text-gray-600 italic mb-4">{herb.latinName}</p>)}
        ...
        {herb.indications && Array.isArray(herb.indications) && herb.indications.length > 0 && (<div className="my-4">
            ...
            <div className="flex flex-wrap gap-2">
              {herb.indications.map((indication, idx) => {
                    ...
                    const match = symptoms.find(s => s.slug.toLowerCase() === (indication === null || indication === void 0 ? void 0 : indication.toLowerCase()) ||
                        s.name.toLowerCase() === (indication === null || indication === void 0 ? void 0 : indication.toLowerCase()));
        ...
        {herb.traditionalUses && Array.isArray(herb.traditionalUses) && (<div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 my-4">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg h-fit">
          ...
          <div className="space-y-4">
            {mockProducts.map((product, idx) => (<div key={idx} className="border border-green-200 rounded-lg p-4 hover:shadow-md transition-shadow mb-4 bg-white">
